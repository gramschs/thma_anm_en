...
maximum value occur, and why can this already be guessed without running the
code?
```
...
energy is always at the highest measured speed. This guess can therefore
already be derived from the formula, without running the code.
````
