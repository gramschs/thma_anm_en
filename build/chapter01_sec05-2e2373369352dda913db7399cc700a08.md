...
decimal number but bundles the two values `7` and `0` into a pair. No error
occurs in the process, which makes this typo particularly treacherous. For
decimal numbers, therefore, always use a point instead of a comma.
````
